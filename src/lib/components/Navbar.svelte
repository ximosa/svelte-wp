<header class="surface-container-lowest" >
   ...
   <menu class="no-wrap">
    ...
    <dialog id="dialog-navigation" class="left">
        ...
        <a class="row round" href="https://www.webgae.com/p/mis-trabajos.html">
          <i>terminal</i>
          <span>Trabajos</span>
        </a>
        ...
        <a class="row round" href="https://www.webgae.com/p/precios.html">
          <i>euro_symbol</i>
          <span>Precios</span>
        </a>
        <a class="row round" href="https://www.webgae.com/p/servicios_17.html">
          <i>design_services</i>
          <span>Servicios</span>
        </a>
     <a class="circle transparent" href="https://www.artepintu.com/" target="_blank">   <i>palette</i> </a>
      ...
      <dialog class="max" id="dialog-modal">
<div class="grid medium-space">
<div class="s12 m12 l6 large-padding center-align">
    <nav class="left-align">
  <button class="border small-round small" data-ui="#dialog-modal"><i>arrow_back</i> Cancelar</button>
</nav> 
